...
export class LambdaStack extends Construct {
    ...
    constructor(
        ...
        this.lambdaLayer = new lambda.LayerVersion(this, `AppRoleMssSharedLayer-${stage}`, {
            code: lambda.Code.fromAsset(path.join(__dirname, '../shared')),
            compatibleRuntimes: [lambda.Runtime.PYTHON_3_11],
        })

        this.libLayer = new lambda.LayerVersion(this, `AppRoleMssLibLayer-${stage}`, {
            code: lambda.Code.fromAsset(path.join(__dirname, '../node_dependencies/nodejs')),
            compatibleRuntimes: [lambda.Runtime.PYTHON_3_11],
        })
